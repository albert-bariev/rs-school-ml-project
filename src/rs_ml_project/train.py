...
parser.add_argument(
    "-d", "--dataset", default="././data/train.csv", type=str, help="path to dataset"
)
...
parser.add_argument("-rs", "--random-state", default=13, type=int, help="random state")

parser.add_argument(
    "-m", "--model", default="rf", type=str, choices=["rf", "knn"], help="model to fit"
)
...
parser.add_argument(
    "-sc", "--scaler", default=None, type=str, choices=["minmax", "std"], help="scaler"
)
...
parser.add_argument(
    "-md", "--max-depth", default=None, type=int, help="The maximum depth of the tree."
)
